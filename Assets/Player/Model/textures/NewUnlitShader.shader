...
Shader "Our Toonshader Vol. 3" {
    Properties{
     ...
     _CollorGlowFloor1("Coolor glow Floor1", Color) = (0.5,0.5,0.5,1)
     _CollorGlowFloor2("Coolor glow Floor2", Color) = (0.5,0.5,0.5,1)
     _CollorGlowFloor3("Coolor glow Floor3", Color) = (0.5,0.5,0.5,1)
